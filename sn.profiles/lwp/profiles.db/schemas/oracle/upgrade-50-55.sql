...
ALTER TABLE EMPINST.EMPLOYEE ADD H_TENANT_KEY VARCHAR2(36) DEFAULT '00000000-0000-0000-0000-040508202233' NOT NULL;
...
ALTER TABLE EMPINST.SNPROF_SCHEMA ADD PRESCHEMAVER VARCHAR2(10) DEFAULT '0' NOT NULL;
ALTER TABLE EMPINST.SNPROF_SCHEMA ADD POSTSCHEMAVER VARCHAR2(10) DEFAULT '0' NOT NULL;
