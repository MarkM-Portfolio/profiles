...
ALTER TABLE EMPINST.EMP_DRAFT ADD ( CONSTRAINT EMP_DRAFT_PK PRIMARY KEY (PROF_KEY, PROF_UPDATE_SEQUENCE, TENANT_KEY) USING INDEX TABLESPACE PROFINDEXTABSPACE );
