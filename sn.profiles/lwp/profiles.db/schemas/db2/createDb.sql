...
CREATE TABLE EMPINST.EMPLOYEE  (
	...
	PROF_DEPARTMENT_NUMBER	VARCHAR(24) ,
	...
	PROF_SOURCE_URL		VARCHAR(512),
	PROF_SRC_UID_LOWER	VARCHAR(256) NOT NULL,
...
CREATE INDEX EMPINST.IDHASH_UDX ON EMPINST.EMPLOYEE 
		(PROF_IDHASH ASC, TENANT_KEY) ALLOW REVERSE SCANS@
...
CREATE TABLE EMPINST.PEOPLE_TAG (
	...
	PROF_TYPE VARCHAR(36) NOT NULL DEFAULT 'general',
	TENANT_KEY	VARCHAR(36) DEFAULT '00000000-0000-0000-0000-040508202233' NOT NULL
)
	IN USERSPACE4K INDEX IN USERSPACE4K@
...
------------------------------------------------
 ...
 CREATE TABLE EMPINST.DEPARTMENT  (
		  PROF_DEPARTMENT_CODE	VARCHAR(24) NOT NULL, 
...
------------------------------------------------
 ...
 CREATE TABLE EMPINST.ORGANIZATION  (
		  PROF_ORGANIZATION_CODE	VARCHAR(64) NOT NULL, 
...
CREATE TABLE EMPINST.COUNTRY  (
		  PROF_ISO_COUNTRY_CODE	VARCHAR(3) NOT NULL, 
...
------------------------------------------------
 ...
 CREATE TABLE EMPINST.EMP_TYPE  (
		  PROF_EMPLOYEE_TYPE	VARCHAR(256) NOT NULL, 
...
CREATE TABLE EMPINST.PRONUNCIATION  (
		  PROF_KEY		VARCHAR(36) NOT NULL , 
		  PROF_PRONOUNCE	BLOB(100000) LOGGED NOT COMPACT , 
		  PROF_UPDATED		TIMESTAMP DEFAULT CURRENT TIMESTAMP NOT NULL,
		  PROF_FILE_TYPE	VARCHAR (50) NOT NULL DEFAULT 'audio/wav',
		  TENANT_KEY		VARCHAR(36) DEFAULT '00000000-0000-0000-0000-040508202233' NOT NULL
 )
 	IN USERSPACE4K INDEX IN USERSPACE4K@  
...
CREATE TABLE EMPINST.PROF_CONNECTIONS (
		PROF_CONNECTION_ID	VARCHAR(36) NOT NULL,
		PROF_SOURCE_KEY		VARCHAR(36) NOT NULL,
		PROF_TARGET_KEY		VARCHAR(36) NOT NULL,
		PROF_CREATED_BY_KEY	VARCHAR(36) NOT NULL,
		PROF_LASTMOD_BY_KEY	VARCHAR(36) NOT NULL,
		PROF_LASTMOD		TIMESTAMP NOT NULL,
		PROF_CREATED		TIMESTAMP NOT NULL,
		PROF_STATUS		SMALLINT NOT NULL,
		PROF_TYPE		VARCHAR(36) NOT NULL,
		PROF_MESSAGE		VARCHAR(2000),
		TENANT_KEY		VARCHAR(36) DEFAULT '00000000-0000-0000-0000-040508202233' NOT NULL
)
	IN USERSPACE4K INDEX IN USERSPACE4K@
