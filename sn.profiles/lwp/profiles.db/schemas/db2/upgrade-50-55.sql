...
ALTER TABLE EMPINST.EMPLOYEE ADD COLUMN H_TENANT_KEY VARCHAR(36) NOT NULL DEFAULT '00000000-0000-0000-0000-040508202233'@
...
------
-- add pre/post schema version info (fixup 55)
------
