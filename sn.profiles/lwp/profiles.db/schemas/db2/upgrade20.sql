...
---  BEFORE RUNNING THIS SCRIPT, RUN JAVA PROGRAM TO UPDATE EMPLOYEE TABLE 

---  This script will upgrade a v1.0.2 profiles database to 2.0  For interim upgrades
---  please obtain a special copy from IBM

------------------------------------------------
-- DDL Statements for table "EMPINST"."EMPLOYEE"
------------------------------------------------

--- step 0: create schema table version
...
CREATE INDEX "EMPINST"."GIVEN_NAME_IDX2" ON "EMPINST"."GIVEN_NAME" 
		("PROF_GIVENNAME" ASC, "PROF_KEY" ASC) ALLOW REVERSE SCANS@
...
RENAME TABLE "EMPINST"."PRONUNCIATION" TO "PRONUNCE_T"@
COMMIT@
...
RENAME TABLE "EMPINST"."CHG_EMP_DRAFT" TO "CHG_EMP_DRAFT_T"@
COMMIT@
...
------------------------------------------------
-- DDL Statements for schema SNCORE
------------------------------------------------
CREATE SCHEMA SNCORE@
...
CREATE TABLE "EMPINST"."PROF_CONNECTIONS" (
		...
		"PROF_VISIBILITY" SMALLINT NOT NULL,
		"PROF_TYPE" SMALLINT NOT NULL,
		"PROF_VALUE" VARCHAR(36) NOT NULL,
		"PROF_MESSAGE" VARCHAR(2000),
	CONSTRAINT "PK" PRIMARY KEY ("PROF_CONNECTION_ID")
	) IN USERSPACE4K INDEX IN USERSPACE4K@
