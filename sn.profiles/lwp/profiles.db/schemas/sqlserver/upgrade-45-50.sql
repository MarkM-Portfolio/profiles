...
ALTER TABLE EMPINST.EMPLOYEE ADD PROF_MODE NUMERIC(5,0) DEFAULT 0 NOT NULL;
GO
...
ALTER TABLE EMPINST.GIVEN_NAME ADD PROF_MODE NUMERIC(5,0) DEFAULT 0 NOT NULL;
...
-- mode column from fixup 43
ALTER TABLE EMPINST.SURNAME ADD PROF_MODE NUMERIC(5,0) DEFAULT 0 NOT NULL;
GO
...
--====
-- Support a type on a tag(fixup41)
--====
...
------
-- PROFILE_EXTENSIONS: add TENANT columns and FK constraints (fixup42)
------
