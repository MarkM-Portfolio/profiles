...
--ALTER TABLE EMPINST.PROFILE_EXTENSIONS ADD CONSTRAINT PROFEXT_TENT_UK UNIQUE (PROF_KEY, TENANT_KEY);
--GO
...
--ALTER TABLE EMPINST.PROFILE_EXT_DRAFT ADD CONSTRAINT PREXTDRFT_TENT_UK UNIQUE (PROF_KEY, TENANT_KEY);
--GO
...
ALTER TABLE EMPINST.EMP_DRAFT ADD CONSTRAINT EMPDRAFT_TENT_UK UNIQUE (PROF_KEY, TENANT_KEY);
GO
...
ALTER TABLE EMPINST.CHG_EMP_DRAFT ADD CONSTRAINT CHEMPDRFT_TENT_UK UNIQUE (PROF_KEY, TENANT_KEY);
GO
...
UPDATE EMPINST.SNPROF_SCHEMA SET DBSCHEMAVER= 34, RELEASEVER='4.5.0.0' WHERE COMPKEY='Profiles';
GO