...
DROP INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY.SNMSGV_ENTRY_ORDER_IDR;
DROP INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY.SNMSGV_ENTRY_LASTUPDATE_IDX;
DROP INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY.SNMSGV_ENTRY_LASTUPDATE_IDR;
DROP INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY.SNMSGV_ENT_WALKER_IDX;
...
-- drop old indexes
DROP INDEX {SUBST_SCHEMA}.SNMSGV_COMMENT.SNMSGV_COMMENT_PUBLISHED_IDX;
DROP INDEX {SUBST_SCHEMA}.SNMSGV_COMMENT.SNMSGV_COMMENT_PUBLISHED_IDR;
DROP INDEX {SUBST_SCHEMA}.SNMSGV_COMMENT.SNMSGV_COMMENT_LASTUPDATE_IDX;
DROP INDEX {SUBST_SCHEMA}.SNMSGV_COMMENT.SNMSGV_COMMENT_LASTUPDATE_IDR;
