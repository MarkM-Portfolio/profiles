...
DROP INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY_ORDER_IDR;
DROP INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY_LASTUPDATE_IDX;
DROP INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY_LASTUPDATE_IDR;
...
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY_ORDER_IDR ON {SUBST_SCHEMA}.SNMSGV_ENTRY (VECTOR_ID DESC, ENTRY_TYPE DESC, PUBLISHED DESC, ENTRY_ID DESC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
...
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY_LASTUPDATE_IDX ON {SUBST_SCHEMA}.SNMSGV_ENTRY (VECTOR_ID ASC, ENTRY_TYPE ASC, LASTUPDATE ASC, ENTRY_ID ASC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY_LASTUPDATE_IDR ON {SUBST_SCHEMA}.SNMSGV_ENTRY (VECTOR_ID DESC, ENTRY_TYPE DESC, LASTUPDATE DESC, ENTRY_ID DESC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};

CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENT_WALKER_IDX ON {SUBST_SCHEMA}.SNMSGV_ENTRY (ENTRY_TYPE ASC, PUBLISHED ASC, ENTRY_ID ASC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENT_WALKER_IDR ON {SUBST_SCHEMA}.SNMSGV_ENTRY (ENTRY_TYPE DESC, PUBLISHED DESC, ENTRY_ID DESC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
...
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENT_WALKER_LU_IDX ON {SUBST_SCHEMA}.SNMSGV_ENTRY (ENTRY_TYPE ASC, LASTUPDATE ASC, ENTRY_ID ASC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENT_WALKER_LU_IDR ON {SUBST_SCHEMA}.SNMSGV_ENTRY (ENTRY_TYPE DESC, LASTUPDATE DESC, ENTRY_ID DESC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
...
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY_ORDR2_IDX ON {SUBST_SCHEMA}.SNMSGV_ENTRY (VECTOR_ID ASC, PUBLISHED ASC, ENTRY_ID ASC, ENTRY_TYPE ASC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY_ORDR2_IDR ON {SUBST_SCHEMA}.SNMSGV_ENTRY (VECTOR_ID DESC, PUBLISHED DESC, ENTRY_ID DESC, ENTRY_TYPE DESC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
...
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY_LASTUPDT2_IDX ON {SUBST_SCHEMA}.SNMSGV_ENTRY (VECTOR_ID ASC, LASTUPDATE ASC, ENTRY_ID ASC, ENTRY_TYPE ASC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENTRY_LASTUPDT2_IDR ON {SUBST_SCHEMA}.SNMSGV_ENTRY (VECTOR_ID DESC, LASTUPDATE DESC, ENTRY_ID DESC, ENTRY_TYPE DESC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};

CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENT_WLKR2_IDX ON {SUBST_SCHEMA}.SNMSGV_ENTRY (PUBLISHED ASC, ENTRY_ID ASC, ENTRY_TYPE ASC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENT_WLKR2_IDR ON {SUBST_SCHEMA}.SNMSGV_ENTRY (PUBLISHED DESC, ENTRY_ID DESC, ENTRY_TYPE DESC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
...
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENT_WLKR2_LU_IDX ON {SUBST_SCHEMA}.SNMSGV_ENTRY (LASTUPDATE ASC, ENTRY_ID ASC, ENTRY_TYPE ASC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_ENT_WLKR2_LU_IDR ON {SUBST_SCHEMA}.SNMSGV_ENTRY (LASTUPDATE DESC, ENTRY_ID DESC, ENTRY_TYPE DESC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};

-- drop old indexes
DROP INDEX {SUBST_SCHEMA}.SNMSGV_COMMENT_PUBLISHED_IDX;
DROP INDEX {SUBST_SCHEMA}.SNMSGV_COMMENT_PUBLISHED_IDR;
DROP INDEX {SUBST_SCHEMA}.SNMSGV_COMMENT_LASTUPDATE_IDX;
DROP INDEX {SUBST_SCHEMA}.SNMSGV_COMMENT_LASTUPDATE_IDR;
...
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_COMMENT_PUBLISHED_IDR ON {SUBST_SCHEMA}.SNMSGV_COMMENT (ENTRY_ID DESC, PUBLISHED DESC, COMMENT_ID DESC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
...
CREATE INDEX {SUBST_SCHEMA}.SNMSGV_COMMENT_LASTUPDATE_IDR ON {SUBST_SCHEMA}.SNMSGV_COMMENT (ENTRY_ID DESC, LASTUPDATE DESC, COMMENT_ID DESC)
	TABLESPACE {SUBST_ORACLE_IDXSPACE8K};
