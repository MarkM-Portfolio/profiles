...
ALTER TABLE {SUBST_SCHEMA}.SNMSGV_ENTRY ADD EXTPROPS CLOB;
COMMIT;

ALTER TABLE {SUBST_SCHEMA}.SNMSGV_COMMENT ADD EXTPROPS CLOB;
COMMIT;
...
CREATE UNIQUE INDEX {SUBST_SCHEMA}.SNMSGV_ENTREC_UDX ON 
	{SUBST_SCHEMA}.SNMSGV_ENTRY_REC (ENTRY_ID ASC, CREATEDBY ASC) TABLESPACE {SUBST_ORACLE_IDXSPACE4K};
