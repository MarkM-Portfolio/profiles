...
CREATE TABLE {SUBST_SCHEMA}.DYNA_DEFS (
	...
	APPID		VARCHAR(64) CCSID 1208 NOT NULL,
	OBJTYPE		VARCHAR(64) CCSID 1208,
	OBJFACET	VARCHAR(128) CCSID 1208,
	DEFMD5		CHAR(32) CCSID 1208 NOT NULL,
	DEFPROPS	CLOB(1M) CCSID 1208, 
	CONSTRAINT {SUBST_SCHEMA}.DYNA_DEF_PK PRIMARY KEY (DEFID)
);
...
CREATE TABLE {SUBST_SCHEMA}.DYNA_OBJ_REF (
	...
	OBJIDSTR	CHAR(36) CCSID 1208 NOT NULL,
	OBJDESC		VARCHAR(256) CCSID 1208 NOT NULL,
	CONSTRAINT {SUBST_SCHEMA}.DYNA_OBJ_PK PRIMARY KEY (OBJID)
) ;

-- FK
ALTER TABLE {SUBST_SCHEMA}.DYNA_OBJ_REF ADD CONSTRAINT {SUBST_SCHEMA}.DYNA_DEF_FK FOREIGN KEY (DEFID)
...
CREATE TABLE {SUBST_SCHEMA}.DYNA_ATTRS (
	...
	ATTRKEY		VARCHAR(256) CCSID 1208 NOT NULL,
	ATTRORDER	INTEGER NOT NULL,
	ATTRVAL		VARCHAR(2000) CCSID 1208,
	ATTRVALEXT	BLOB(1M)
);
...
ALTER TABLE {SUBST_SCHEMA}.DYNA_ATTRS 
	ADD CONSTRAINT {SUBST_SCHEMA}.DYNA_ATTRS_PK PRIMARY KEY(ATTRID);
	
ALTER TABLE {SUBST_SCHEMA}.DYNA_ATTRS ADD CONSTRAINT {SUBST_SCHEMA}.DYNA_ATTR_FK FOREIGN KEY (OBJID)
