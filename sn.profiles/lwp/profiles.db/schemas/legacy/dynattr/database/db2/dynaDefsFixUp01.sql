...
INSERT INTO {SUBST_SCHEMA}.SNCORE_SCHEMA (COMPKEY, DBSCHEMAVER) VALUES ('LC_APPEXT_DYNATTR_DEFS', 1)@
...
CREATE TABLE {SUBST_SCHEMA}.DYNA_DEFS (
	...
	DEFPROPS	CLOB(1M) LOGGED COMPACT NOT NULL, 
...
CREATE TABLE {SUBST_SCHEMA}.DYNA_OBJ_REF (
	...
	CONSTRAINT PK PRIMARY KEY (OBJID)
) IN {SUBST_USERSPACE4K} INDEX IN {SUBST_USERSPACE4K_INDEX}@
...
CREATE UNIQUE INDEX {SUBST_SCHEMA}.DYNA_ATTRS_UIDX 
	ON {SUBST_SCHEMA}.DYNA_ATTRS (OBJID ASC, ATTRKEY ASC)
