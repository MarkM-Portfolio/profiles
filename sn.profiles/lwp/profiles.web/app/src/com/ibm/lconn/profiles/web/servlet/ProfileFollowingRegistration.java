...
import com.ibm.lconn.following.internal.impl.FollowingImplRegistration;
import com.ibm.lconn.profiles.internal.service.ProfileFollowingEJBImpl;
...
public class ProfileFollowingRegistration implements ServletContextListener {
	...
	FollowingImplRegistration.register(Source.PROFILES, ProfileFollowingEJBImpl.getInstance() );	    
    }
