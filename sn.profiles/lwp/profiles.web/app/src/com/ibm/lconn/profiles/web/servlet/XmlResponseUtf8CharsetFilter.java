 ...
 * 
 */
public class XmlResponseUtf8CharsetFilter implements Filter {

	private static class XmlUtf8ResponseWrapper extends
			HttpServletResponseWrapper {

		public XmlUtf8ResponseWrapper(HttpServletResponse response) {
			super(response);
		}
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if (m != null && m.matches()) {
			XmlUtf8ResponseWrapper wrapper = new XmlUtf8ResponseWrapper(
					httpResp);
