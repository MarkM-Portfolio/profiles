 ...
 */
public class FriendInvitationTestCase extends TestCase
{
	String serverURL = "http://profilesdev.dyn.webahead.ibm.com:9080";
	...
	public void testBaseTest() throws Exception
	{
		...
		xmlDocInputStream = new FileInputStream(
				"./src/com/ibm/lconn/profiles/test/atomxslt/invitations.xml");

		//xmlDocInputStream = XSLTUtil.getInputStream( serverURL + "/profiles/xml/invitations.xml");
...
//					"C:/Documents and Settings/Administrator/clearcase/rpena_LC2_0_sn_profiles/socnet.05/sn.profiles/lwp/peoplepages.web/WebContent/tools/reporttochain.xml");
		...
		FileInputStream xslTemplateInputStream = new FileInputStream(
				"../peoplepages.web/WebContent/xslt/friends/accept-invitations.xsl");
