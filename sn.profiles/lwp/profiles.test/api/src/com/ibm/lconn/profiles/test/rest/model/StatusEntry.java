...
public class StatusEntry extends AtomEntry
{
  ...
  public StatusEntry(Entry e) throws Exception
  {
    super(e);
    ...
    Assert.assertEquals(e.getCategories(ApiConstants.SocialNetworking.SCHEME_MESSAGE_TYPE).get(0).getTerm(), ApiConstants.SocialNetworking.STATUS);
  ...
  public StatusEntry validate() throws Exception
  {
    super.validate();
  ...
  public Entry toEntry() throws Exception{
    ...
    entry.addCategory(ApiConstants.SocialNetworking.SCHEME_MESSAGE_TYPE, ApiConstants.SocialNetworking.STATUS, null);
